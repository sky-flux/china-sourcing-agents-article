...
Sourcing electronics from China involves five stages: defining your specification, finding and qualifying factories, placing a sample order, running a factory audit, and managing production. A first order typically takes 8–14 weeks end-to-end.

The most common mistake is treating Alibaba as the endpoint rather than the starting point.
...
The more specific you are, the faster factories can tell you whether they can help.
...
- Specific questions about their capability
...
Never place a first production order at a factory you haven't audited. Even a 4-hour visit covers the basics:
...
See the full [Factory Audit Checklist](factory-audit-checklist.md) for 47 specific items to verify.
...
After audit, sample order, and sample approval, you're ready for production. This process typically takes 5 months from initial supplier search to delivery of 5,000 units for a first-time [consumer electronics](https://china-sourcing-agents.com/industries/consumer-electronics) project.

See the [China Payment Terms guide](china-payment-terms-explained.md) for structuring your deposit and balance payments.

---

## Further reading

- [Factory Audit Checklist: 47 Items](factory-audit-checklist.md)
...
- [Full guide on china-sourcing-agents.com](https://china-sourcing-agents.com/guides/how-to-source-electronics-from-china)
- [Sourcing & Supplier Matching service](https://china-sourcing-agents.com/services/sourcing)
