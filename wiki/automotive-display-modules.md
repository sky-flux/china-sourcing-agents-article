...
Automotive display modules convert digital video signals into visible images for instrument clusters, center information displays (CID), rear-seat entertainment (RSE), and head-up display (HUD) projection surfaces. They integrate a liquid crystal or OLED panel, a backlight assembly (for non-emissive technologies), a timing controller (TCON), and optionally a touch sensor stack.
