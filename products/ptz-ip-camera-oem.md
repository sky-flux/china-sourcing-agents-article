...
4MP PTZ IP camera: 25× optical zoom, IR night vision 100m, PoE+ (802.3at), ONVIF S/T/G. OEM from 50 units for integrators and distributors.

---

ONVIF (Open Network Video Interface Forum) profiles define interoperability layers between IP cameras and video management software (VMS). Understanding which profiles are genuinely supported — rather than claimed — is essential for industrial IoT and smart home integration projects.
