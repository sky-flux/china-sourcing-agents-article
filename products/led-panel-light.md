...
**LM79 test report.** This is the photometric test report from an accredited lab (TÜV, Intertek, Bureau Veritas) — essential for electronics quality control documentation. The report shows real lumen output, efficacy, and CCT. If a supplier provides an internal test report rather than a third-party one, treat the spec as unverified.
