...
IP65 solar-powered LED string lights with 10–100 bulb options, 8 lighting modes, dusk-to-dawn automation, and custom bulb/wire color. OEM from 500 units.

---

Battery chemistry selection in outdoor solar lights involves a genuine tradeoff between cost, safety, cold-weather performance, and shipping logistics — not a simple upgrade path. When sourcing solar lighting products from China, this is the first specification to lock down.
