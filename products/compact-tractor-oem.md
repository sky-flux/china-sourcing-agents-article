...
**Licensed-design "equivalent" engines** are what most Chinese tractor OEMs actually use. Three manufacturers dominate this tier: **Changchai** (江淮), **Changfeng** (长丰), and **YangDong** (洋马动力 — this last one is Yanmar's Chinese joint venture). These engines trace their architecture to original Yanmar or Kubota designs via technology transfer agreements that date to the 1980s and 1990s. Displacement figures, bore and stroke, and injection system geometry are closely matched to their Japanese counterparts. In practice, mean time between failures at the 1,000–2,000 hour mark is within 15–20% of genuine units on agricultural duty cycles. The critical difference is emissions compliance: most Chinese-assembled equivalents are tuned to China Stage III (roughly equivalent to EU Stage IIIA), which is legal in non-EU markets but does not meet **EU Stage V** (Regulation (EU) 2016/1628) requirements for new machinery sold in the EU from 2019 onwards.
