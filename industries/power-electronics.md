...
Lithium products require UN 38.3 before transport; standalone cells (PI 965) are heavily restricted on air freight, so sea freight is the practical route for volume battery shipments.
